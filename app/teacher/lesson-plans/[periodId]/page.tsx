  ...
  return (
    <label className="block text-sm font-medium text-slate-700">
      ...
      <textarea
        ...
        className="mt-1 block w-full rounded-md border border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-brand-blue focus:outline-none focus:ring-1 focus:ring-brand-blue"
      />
  ...
  return (
    <div>
      <p className="text-sm text-slate-500">
        {period.academicPlan.subject.name} — {period.academicPlan.grade.name}{" "}
        {period.academicPlan.section.name} · Period {period.periodNumber}
      </p>
